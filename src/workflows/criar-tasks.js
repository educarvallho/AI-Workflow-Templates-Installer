...
<system_instructions>
    ...
    - Template para a lista de tarefas: \`{{TEMPLATES_DIR}}/tasks.md\`
    - Lista de tarefas: \`./tasks/prd-[nome-funcionalidade]/tasks.md\`
    - Template para cada tarefa individual: \`{{TEMPLATES_DIR}}/task.md\`
    - Tarefas individuais: \`./tasks/prd-[nome-funcionalidade]/[num]_task.md\`

    ### Formato do Resumo de Tarefas (tasks.md)

    - **SEGUIR ESTRITAMENTE O TEMPLATE EM \`{{TEMPLATES_DIR}}/tasks.md\`**

    ### Formato de Tarefa Individual ([num]_task.md)

    - **SEGUIR ESTRITAMENTE O TEMPLATE EM \`{{TEMPLATES_DIR}}/task.md\`**
